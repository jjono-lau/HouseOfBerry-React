...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-4 py-4 sticky top-0 z-900 backdrop-blur-xl font-medium bg-primary dark:bg-black border-b border-pink-100 dark:border-none"
    >
      {/* Logo */}
      <a
        href="#home"
