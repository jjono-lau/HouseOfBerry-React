    ...
    <div id='contact' className="flex flex-col items-center gap-7 p-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white">
      ...
      <form onSubmit={onSubmit} className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
        ...
        <div>
          ...
          <div className="flex pl-3 rounded-lg border border-gray-300 dark:primary">
        ...
        {/* <div>
          ...
          <div className="flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600">
             <img src={HouseOfBerryAssets.coffee} alt='' className="h-10"/>
              <input type="email" placeholder='Enter your phone number' className="w-full p-3 text-sm outline-none" required/>
          </div>
        </div> */}
        ...
        <div className="sm:col-span-2">
          ...
          className="w-full p-3 ext-sm outline-none rounded-lg border border-gray-200 dark:primary" required/>
