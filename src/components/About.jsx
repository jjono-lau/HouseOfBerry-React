...
const About = () => {
    ...
    const aboutData = [
        ...
        {
            title: 'Our Values',
            description: 'We value quality, sustainability, and community. Our matcha is sourced from the Japan and handled with care.',
  ...
  return (
    <div id='about' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-primary'>
